				...
				case 1:
					...
					if(op1==1) {
						...
						while(b==false && num!=3) {
							...
							if(Data.validadata(Integer.parseInt(data[0]), Integer.parseInt(data[1]), Integer.parseInt(data[2]))) {
								Data dinsc = new Data();
								Estudante estu = new Estudante(name,nmec,cc,curso,nasc,nsocio,dinsc,requesitar);
								people.add(estu);
					...
					//Funcionarios
						...
						while(b==false && num!=3) {
							...
							if(Data.validadata(Integer.parseInt(data[0]), Integer.parseInt(data[1]), Integer.parseInt(data[2]))) {
								Data dinsc = new Data();
								Funcionario f = new Funcionario(name,cc,nasc,nfunc,nfisc,nsocio,dinsc,requesitar);
								people.add(f);
								out.println("Pessoa foi adicionada");
							}else {
								b=false;
