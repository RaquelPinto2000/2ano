		...
		do {
			...
			switch (opcao) {
				case 1:
					...
					break;
				case 2:
					min = new MinHash("Counter_Strike");
					s = min.compareSignatures();
					...
					break;
				case 3:
					min = new MinHash("Counter_Strike_Global_Offensive");
					s = min.compareSignatures();
				...
				case 4:
					...
					break;
				case 5:
					min = new MinHash("Football_Manager_2015");
					s = min.compareSignatures();
					...
					System.out.println("O ficheiro com a matriz de assinaturas pode ser encontrado em /matriz_Assinaturas/matriz_Sid_Meiers_Football_Manager_2015\n");

					break;
				case 6: 
					min = new MinHash("Garrys_Mod");
					s = min.compareSignatures();
					...
					break;
				case 7:
					min = new MinHash("Grand_Theft_Auto_V");
					s = min.compareSignatures();
					...
					break;
				case 8:
					min = new MinHash("Sid_Meiers_Civilization_5");
					s = min.compareSignatures();
					...
					break;
				case 9:
					min = new MinHash("Team_Fortress_2");
					s = min.compareSignatures();
					...
					break;
				case 10:
					min = new MinHash("The_Elder_Scrolls_V");
					s = min.compareSignatures();
