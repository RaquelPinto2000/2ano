...
Stack* StackCreate(void) { // aluca espacos (memoria) para as instancias numa stack de ponteiros
...
void StackDestroy(Stack** p) {
  ...
  StackClear(s); // primeiro limpas a stack e so depois libertas a memoria
