...
// GraphShortestPathsWithQueue EXAMPLE
//
...
int main(void) {
  ...
  //GraphDisplay(g01);
  int vertex = 0;
  GraphShortestPathsWithQueue* traversal = GraphShortestPathsWithQueueExecute(g01, vertex);
  GraphShortestPathsWithQueueDisplay(traversal);
